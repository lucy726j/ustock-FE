        ...
        >
            ...
            {showOneConfirmBtn ? (
                ...
                <div style={{display : 'flex', justifyContent: 'center', marginTop: '20px'}}>
                    {onConfirm && (
                        <Button onClick={onConfirm} size="plusBtn" colorType="main" state="normal">
                            {text}
                        </Button>
                    )}
                </div>
                ...
                <div style={{display : 'flex', justifyContent: 'center', marginTop: '20px'}}>
                    {showCancelButton && (
                        <Button onClick={onRequestClose} size="small" colorType="cancel" state="normal">
                            {cancelLabel}
                        </Button>
                    )}
                    {showConfirmButton && onConfirm && (
                        <Button onClick={onConfirm} size="small" colorType="main" state="normal">
                            {confirmLabel}
                        </Button>
                    )}
                </div>
